...
df_face = pd.read_csv("vgg_face_data_4096_7_cropped.csv")
df_swipe = pd.read_csv("data/user1.csv")
...
plt.title("Content-Based Filtering with XGBoost (Raw + Cropped Features)")
